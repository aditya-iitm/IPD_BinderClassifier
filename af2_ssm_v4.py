...
optimizer_state_path = '/net/scratch/aditya20/af2exp/model/state_ssm_v4_5799.pkl'
global_step_path     = '/net/scratch/aditya20/af2exp/model/ssm_v4_global_step.npy'
model_weights_path   = '/net/scratch/aditya20/af2exp/model/ssm_v4_5799.pkl'
...
if load_optimizer:
    ...
    binder_model_params = pickle.load(open(f'{scratch_path}/model/binder_params_pae_and_dist.pkl', "rb"))
        ...
        for n, combined_batch in enumerate(zip(train_loader, train_pos_loader)):
            for j, batch in enumerate(combined_batch):
                ...
                if (global_step+1) % 1 == 0:
                    ...
                    pickle.dump(loss_log, open('/net/scratch/aditya20/af2exp/model/ssm_v4_loss_log_run1.pkl', "wb"))
                ...
                if (global_step+1) % 200 == 0:
                    np.save('/net/scratch/aditya20/af2exp/model/ssm_v4_global_step.npy', global_step)
                    save_params = jax.tree_map(lambda x: x[0,], replicated_params)
                    pickle.dump(save_params, open('/net/scratch/aditya20/af2exp/model/ssm_v4'+f'_{global_step}.pkl', "wb"))
                    pickle.dump(opt_state, open('/net/scratch/aditya20/af2exp/model/state_ssm_v4'+f'_{global_step}.pkl', "wb"))
