...
model_config.data.common.max_extra_msa = 256
...
for e in range(10):
        ...
        for j, batch in enumerate(train_loader):
            ...
            if (global_step+1) % 1 == 0:
                ...
                pickle.dump(loss_log, open('/net/scratch/aditya20/af2exp/model/ssm_af2_frozen_loss_log_run3.pkl', "wb"))
                pickle.dump(grad_log, open('/net/scratch/aditya20/af2exp/model/ssm_af2_frozen_grad_log_run3.pkl', "wb"))
            ...
            if (global_step+1) % 500 == 0:
                np.save('/net/scratch/aditya20/af2exp/model/ssm_af2_frozen2.npy', global_step)
                replicated_params2 = hk.data_structures.merge(replicated_af2_model_params, replicated_binder_model_params)
                save_params = jax.tree_map(lambda x: x[0,], replicated_params2)
                pickle.dump(save_params, open('/net/scratch/aditya20/af2exp/model/ssm_af2_frozen3'+f'_{global_step}.pkl', "wb"))
                pickle.dump(opt_state, open('/net/scratch/aditya20/af2exp/model/state_ssm_af2_frozen3'+f'_{global_step}.pkl', "wb"))
