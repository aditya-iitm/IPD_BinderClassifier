...
for e in range(10):
        ...
        for j, batch in enumerate(train_loader):
            ...
            if (global_step+1) % 1 == 0:
                ...
                pickle.dump(loss_log, open('/net/scratch/aditya20/af2exp/model/ssm_af2_frozen_PAEonly_loss_log.pkl', "wb"))
                #pickle.dump(grad_log, open('/net/scratch/aditya20/af2exp/model/ssm_af2_frozen_PAEonly_grad_log.pkl', "wb"))
            ...
            if (global_step+1) % 500 == 0:
                np.save('/net/scratch/aditya20/af2exp/model/ssm_af2_frozen_PAEonly.npy', global_step)
                ...
                pickle.dump(save_params, open('/net/scratch/aditya20/af2exp/model/ssm_af2_frozen_PAEonly'+f'_{global_step}.pkl', "wb"))
                pickle.dump(opt_state, open('/net/scratch/aditya20/af2exp/model/state_ssm_af2_frozen_PAEonly'+f'_{global_step}.pkl', "wb"))
